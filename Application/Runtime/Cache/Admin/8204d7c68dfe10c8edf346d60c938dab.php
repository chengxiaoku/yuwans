...
<section class="content-header">
    ...
    <section class="content">
        <div class="row">
            <form action="<?php echo U('slider/edit');?>" method="post">
                <!-- left column -->
                <div class="col-md-6">
                    ...
                    <div class="box box-solid">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name='title' value="<?php echo ($data["title"]); ?>" placeholder="输入标题 ..." id=""
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control wp50" id="netbar" name="netbar_id">
                                    <?php if($netbar != ''): ?><option value="<?php echo ($netbar["user_id"]); ?>"><?php echo ($netbar["title"]); ?></option>
                                        <?php else: ?>
                                        <option value="">未选择网吧</option><?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control wp50" id="game" name="game_id">
                                    ...
                                    <?php if(is_array($games)): $i = 0; $__LIST__ = $games;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option
                                        <?php if($game_id == $vo['id']): ?>selected<?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control wp50" id="war" name="war_id">
                                    ...
                                    <?php if(is_array($wars)): $i = 0; $__LIST__ = $wars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($war_id == $vo['id']): ?><option value="<?php echo ($vo["id"]); ?>" selected><?php echo ($vo["title"]); ?></option>
                                        <?php else: ?>
                ...
                <div class="col-md-6">
                    ...
                    <div id="slides_placehold">
                        <?php if(img) {?>
                        <?php if(is_array($img)): $i = 0; $__LIST__ = $img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box box-success direct-chat direct-chat-success collapsed-box images_box">
                                ...
                                <div class="box-body form-horizontal" style="padding:10px 0;">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10  ">
                                            <input type="text" placeholder="标题..." value="<?php echo ($vo["title"]); ?>" id="title_<?php echo ($i); ?>"
                                                   name="images[<?php echo ($i); ?>][title]" class="form-control inline-block wp50"
                                                   onblur="chk('<?php echo ($i); ?>')">
                                            <label for="inputError" class="control-label" id="title_<?php echo ($i); ?>_error"
                                                   style="display:none;"><i class="fa"></i> <span
                                                    id="title_<?php echo ($i); ?>_error_msg">图片名不能为空</label>
                                        </div>
                                    </div>
                                    <!--
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10 ">
                                                    <input type="text" placeholder="连接地址..." id="link_<?php echo ($i); ?>" value="<?php echo ($vo["url"]); ?>" name="images[<?php echo ($i); ?>][url]" class="form-control wp50">
                                                  </div>
                                                </div>
                                  -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group wp50">
                                                <img src="<?php echo ($vo["img"]); ?>" width="300">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group wp50">
                                                <input type="text" class="form-control " id="image_<?php echo ($i); ?>"
                                                       value="<?php echo ($vo["img"]); ?>" placeholder="上传图片..." name="images[<?php echo ($i); ?>][img]"
                                                       readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 ">
                                            <textarea rows="2" placeholder="输入内容 ..." class="form-control wp50"
                                                      name="images[<?php echo ($i); ?>][description]"><?php echo ($vo["description"]); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                      <label class="col-sm-2 control-label" for="">序号</label>
                                      <div class="col-sm-10  ">
                                        <input type="text" placeholder="" value="<?php echo ($vo["listorder"]); ?>" id="" name="images[<?php echo ($i); ?>][listorder]" class="form-control inline-block w50">
                                      </div>
                                    </div> -->
...
<script type="text/javascript">
    ...
    $(function () {
        var province = "<?php echo ($data['province_id']); ?>";
        var city = "<?php echo ($data['city_id']); ?>";
        var distract = "<?php echo ($data['distract_id']); ?>";
        //省市区三级联动
    ...
    switch (type){
        case 'home':
            $("option[value='home']").attr('selected','true');
            break;
        case 'game':
            $("option[value='game']").attr('selected','true');
            break;
        case 'community':
            $("option[value='community']").attr('selected','true');
            break;
        default:
            $("option[value='ad']").attr('selected','true');
    }
