        ...
        <div class="row">
            ...
            <div class="col-md-8" style="">
                ...
                <div class="box box-solid" style="">
                    <!-- form start -->
                    <form role="form" method="post" action="<?php echo U('Admin/add');?>">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary w100 btn-flat">添加</button>
                            <a type="submit" class="btn btn-info w100 ml20 btn-flat"
