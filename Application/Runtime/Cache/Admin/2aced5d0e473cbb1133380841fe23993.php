        ...
        <div class="row">
            ...
            <div class="col-md-8" style="">
                ...
                <div class="box box-solid" style="">
                    <!-- form start -->
                    <form role="form" method="post" action="<?php echo U('Game/edit');?>">
                        <div class="box-body" style="">
                            ...
                            <div class="form-group input-group w500">
                                ...
                                <div>
                                    ...
                                    <div style="margin-top:10px;">
                                        <input id="thumb" class="form-control w500 inline-block" value="<?php echo ($data[thumb]); ?>" name="thumb" type="text" style="margin-bottom:10px;" >
                            ...
                            <div class="form-group">
                                <label>场次</label>
                                <div>
                                    <input name="times" value="<?php echo ($data[times]); ?>" type="text" placeholder=""
                            ...
                            <div class="form-group">
                                <label>最多参与人数</label>
                                <div>
                                    <input name="player_max" value="<?php echo ($data[player_max]); ?>" type="text" placeholder=""
                                           class="form-control w200 inline-block">
                                </div>
                            </div>
                            <!-- <div class="form-group">
                                <label>最小参与人数</label>
                                <div>
                                    <input name="player_min" value="<?php echo ($data[player_min]); ?>" type="text" placeholder=""
                                           class="form-control w200 inline-block">
                                </div>
                            </div> -->
                            ...
                            <div class="form-group">
                                <label>最大奖金额</label>
                                <div>
                                    <input name="prize_max" value="<?php echo ($data[prize_max]); ?>" type="text" placeholder=""
                                           class="form-control w200 inline-block">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <input name="prize_min" value="<?php echo ($data[prize_min]); ?>" type="text" placeholder=""
                                           class="form-control w200 inline-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="content" class="form-control wp50" rows="6"
                                              placeholder="输入描述 ..."><?php echo ($data["description"]); ?></textarea>
                                </div>
                            </div>
