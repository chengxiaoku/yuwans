...
<section class="content-header">
    ...
    <section class="content">
        <div class="row">
            <form action="<?php echo U('slider/war');?>" method="post" id="sliderForm">
                <input type="hidden" name="isNewRecord" value="<?php echo ($isNewRecord); ?>">
                    ...
                    <div class="box box-solid">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name='title' value="<?php echo ($model["title"]); ?>" placeholder="输入标题 ..." id=""
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control wp50" id="game" name="game_id">
                                    ...
                                    <?php if(is_array($games)): $i = 0; $__LIST__ = $games;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($game_id == $vo['id']): ?><option value="<?php echo ($vo["id"]); ?>" selected><?php echo ($vo["title"]); ?></option>
                                        <?php else: ?>
