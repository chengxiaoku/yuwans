            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <a class="btn btn-primary" href="<?php echo U('Role/admins_add');?>">添加管理员</a>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-default btn-xs" href="<?php echo U('Role/admins_update',array('val'=>$val['id']));?>">修改</a> <a href="#" d="<?php echo $val['id'] ?>" class="btn btn-default btn-xs del_l">删除</a></td>
                            </tr>
                            <?php $i++; endforeach;?>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    ...
    $("#sel_ok").click(function (){
        ...
        if(sel == ''){
            ...
            _form.action="<?php echo U('Role/admin');?>";
            _form.submit();
        }
    })
